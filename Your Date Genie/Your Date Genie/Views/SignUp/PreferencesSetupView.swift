        ...
        ScrollView(showsIndicators: false) {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("We'll tailor dates to what makes you feel loved")
                        .font(Font.bodySans(12, weight: .regular))
                        .foregroundColor(Color.luxuryMuted)
                    
                    LoveLanguageSelector(
                        selectedLanguage: $viewModel.loveLanguage
                    )
                }
...
struct LoveLanguageSelector: View {
    @Binding var selectedLanguage: LoveLanguage?
...
class PreferencesSetupViewModel: ObservableObject {
    ...
    func savePreferences() {
        ...
        preferences.loveLanguage = loveLanguage ?? .qualityTime
