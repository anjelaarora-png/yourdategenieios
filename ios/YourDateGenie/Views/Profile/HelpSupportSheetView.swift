...
struct HelpSupportSheetView: View {
    ...
    private let faqs: [FAQItem] = [
        ...
        FAQItem(question: "How does Plan Together work?",
        ...
        FAQItem(question: "What does Premium include?",
                answer: "Premium unlocks unlimited date plans plus Love Notes, Gift Finder, Memories, Conversation Starters, and Smart Playlists. Free accounts can generate a limited number of plans before upgrading."),
